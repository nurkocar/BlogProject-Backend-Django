...
from .views import CategoryList, UserRecipeList, RecipeList, RecipeDetail, RecipeCreate, RecipeUpdate, RecipeDelete, IngredientCreate, IngredientUpdateDelete, CommentCreate, LikeCreate
